...
path_h = os.path.join(input_data_path, config['h_file'])
path_h_e = os.path.join(input_data_path, config['h_error_file'])

path_to_output = cfg.PATHS['working_dir']

ds = utils_h.open_thick_raster(path_h)
dr = utils_h.open_thick_raster(path_h_e)
