...
ax0.set_xlabel('$k_{\mathrm{RACMO}}$ [yr$^{-1}$]')
ax0.set_ylabel('$k_{\mathrm{MEaSUREs}}$ [yr$^{-1}$]')
...
ax1.set_xlabel('$k_{\mathrm{RACMO}}$ [yr$^{-1}$]')
ax1.set_ylabel('$k_{\mathrm{ITSlive}}$ [yr$^{-1}$]')
...
ax2.set_xlabel('$k_{\mathrm{ITSlive}}$ [yr$^{-1}$]')
ax2.set_ylabel('$k_{\mathrm{MEaSUREs}}$ [yr$^{-1}$]')
...
ax3.set_xlabel('$q_{\mathrm{calving-RACMO}}$ [km$^3$ yr$^{-1}$]')
ax3.set_ylabel('$q_{\mathrm{calving-MEaSUREs}}$ [km$^3$ yr$^{-1}$]')
...
ax4.set_xlabel('$q_{\mathrm{calving-RACMO}}$ [km$^3$ yr$^{-1}$]')
ax4.set_ylabel('$q_{\mathrm{calving-ITSlive}}$ [km$^3$ yr$^{-1}$]')
...
ax5.set_xlabel('$q_{\mathrm{calving-ITSlive}}$ [km$^3$ yr$^{-1}$]')
ax5.set_ylabel('$q_{\mathrm{calving-MEaSUREs}}$ [km$^3$ yr$^{-1}$]')
